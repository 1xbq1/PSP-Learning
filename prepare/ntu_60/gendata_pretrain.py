...
def gendata(data_path, out_path, ignored_sample_path=None, benchmark='xview', part='eval', training_subjects=None, semi=5):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ignored_sample_path',
                        default='./prepare/ntu_60/samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='../ntu_60_pretrain/')

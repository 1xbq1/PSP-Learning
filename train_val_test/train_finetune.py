...
with TimerBlock("Good Luck") as block:
    ...
    loss_function, loss_function_con = loss_choose(args, block)

    label_data_loader_train, unlabel_data_loader_train, data_loader_val = data_choose(args, block)
    ...
    for epoch in process:
        ...
        global_step, loss = train_net(label_data_loader_train, unlabel_data_loader_train, model, loss_function, loss_function_con, optimizer, global_step, args)
        # label_data_loader, unlabel_data_loader, model, loss_function_reg, loss_function_con, optimizer, global_step, args
